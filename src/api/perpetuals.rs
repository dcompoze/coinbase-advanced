...
impl<'a> PerpetualsApi<'a> {
    ...
    ///
    /// ```no_run
    /// # use coinbase_client::{RestClient, Credentials, models::AllocatePortfolioRequest};
    /// # async fn example() -> coinbase_client::Result<()> {
    /// let client = RestClient::builder()
    ///     .credentials(Credentials::from_env()?)
    ///     .build()?;
    ...
    ///
    /// ```no_run
    /// # use coinbase_client::{RestClient, Credentials, models::SetMultiAssetCollateralRequest};
    /// # async fn example() -> coinbase_client::Result<()> {
    /// let client = RestClient::builder()
    ///     .credentials(Credentials::from_env()?)
    ///     .build()?;
