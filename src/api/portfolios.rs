...
impl<'a> PortfoliosApi<'a> {
    ...
    ///
    /// ```no_run
    /// # use coinbase_client::{RestClient, Credentials, models::ListPortfoliosParams};
    /// # async fn example() -> coinbase_client::Result<()> {
    /// let client = RestClient::builder()
    ///     .credentials(Credentials::from_env()?)
    ///     .build()?;
    ...
    ///
    /// ```no_run
    /// # use coinbase_client::{RestClient, Credentials, models::CreatePortfolioRequest};
    /// # async fn example() -> coinbase_client::Result<()> {
    /// let client = RestClient::builder()
    ///     .credentials(Credentials::from_env()?)
    ///     .build()?;
    ...
    ///
    /// ```no_run
    /// # use coinbase_client::{RestClient, Credentials, models::EditPortfolioRequest};
    /// # async fn example() -> coinbase_client::Result<()> {
    /// let client = RestClient::builder()
    ///     .credentials(Credentials::from_env()?)
    ///     .build()?;
    ...
    ///
    /// ```no_run
    /// # use coinbase_client::{RestClient, Credentials, models::{MoveFundsRequest, MoveFunds}};
    /// # async fn example() -> coinbase_client::Result<()> {
    /// let client = RestClient::builder()
    ///     .credentials(Credentials::from_env()?)
    ///     .build()?;
